...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String q4 ="CREATE TABLE "+TABLE_EVENT+" ("+ID+" integer primary key Autoincrement , "+EVENT_GLOBAL_ID+" integer , "+EVENT_TITLE+" text not null , "+EVENT_DESC+" text not null , "+EVENT_PARTNER_ID+" integer , "+EVENT_PARTNER_NAME+" text , "+EVENT_date+" DATETIME not null , "+EVENT_TYPE+" text not null , "+EVENT_DATA1+" integer , "+EVENT_DATA2+" integer );" ;
